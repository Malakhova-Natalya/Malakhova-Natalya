...
- 👯 до этого работала в GlowByte (аналитик DWH) и Adventum (аналитик данных)
...
**Экспертиза:** проектирование DWH (Kimball), моделирование данных, сбор и анализ требований, разработка ТЗ, ведение проектной документации
